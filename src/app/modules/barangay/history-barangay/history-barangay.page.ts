...
@Component({
  selector: 'app-history-barangay',
  templateUrl: './history-barangay.page.html',
  styleUrls: ['./history-barangay.page.scss'],
})
export class HistoryBarangayPage implements OnInit {
