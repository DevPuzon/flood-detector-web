...
@Component({
  selector: 'app-barangay-register',
  templateUrl: './barangay-register.component.html',
  styleUrls: ['./barangay-register.component.scss'],
})
export class BarangayRegisterComponent implements OnInit {
  ...
  async onSubmit(){ 
    ...
    this.createAuth().then(async passuid=>{   
      ...
      this.router.navigateByUrl('barangay-login');
    }).catch(e=>{
      console.log(e);
      loading.dismiss();
