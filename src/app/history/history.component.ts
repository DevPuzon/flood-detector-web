...
export class HistoryComponent implements OnInit {
  ...
  ngOnInit() { 
    this.initUIDate();
    let distances = localStorage.getItem('distances') ? JSON.parse(localStorage.getItem('distances')) :[];
    let water_levels = localStorage.getItem('water_levels') ? JSON.parse(localStorage.getItem('water_levels')):[];
    let flRate =  localStorage.getItem('flRate') ? JSON.parse(localStorage.getItem('flRate')) :[];
